  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">About Event Planner</h2>
          <p className="text-lg text-gray-600 mb-6">
            We believe that every event should be memorable and stress-free. Our comprehensive event planning platform combines powerful tools with intuitive design to help you create extraordinary experiences.
          </p>
          <p className="text-lg text-gray-600 mb-8">
            Whether you're planning a wedding, corporate event, birthday party, or any special occasion, our platform provides everything you need to bring your vision to life.
          </p>
          <Link to="/about" className="btn-gradient text-white px-8 py-3 rounded-full font-semibold">
            Learn More About Us
          </Link>
        </div>
      </section>
